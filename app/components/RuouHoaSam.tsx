...
export default async function RuouHoaPage() {
  const  category  = "ruou-hoa-sam-ngoc-linh";
  ...
  return (
    <>
      <div className="h-full w-full max-w-8xl mx-auto p-1 md:p-4 mt-1 bg-white">
        ...
        <div
            ...
            >
                <div className="text-center text-sm md:text-base font-normal">
                    <span>Rượu Hoa Sâm Ngọc Linh</span>
                </div>
            </div>
        ...
        <Link href="/san-pham/ruou-hoa-sam-ngoc-linh" className="inline-flex items-center rounded-md border border-transparent bg-blue-600 px-6 py-3 text-base font-medium text-white shadow-sm transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
          Xem thêm sản phẩm
